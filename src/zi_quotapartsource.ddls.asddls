...
@EndUserText.label: 'Quota PartSource'
...
{
  key _Quota.QuotaArrangement                  as QuotaArrangement1,
      ...
      _QuotaItem.QuotaArrangementItem          as QuotaArrangementItem,
...
where   _Quota.ValidityEndDate >= $session.system_date
